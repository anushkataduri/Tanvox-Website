  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        transition={{ duration: 0.45, ease: 'easeOut' }}
      >
        <div className="bento-card-icon-main">
          {service.icon}
        </div>
          ...
          >
            <div className="bento-hover-content">
              <motion.div 
                ...
                transition={{ duration: 0.45, ease: 'easeOut' }}
              >
                <div className="bento-hover-icon-wrapper">
                  {service.icon}
                </div>
                <h3 className="bento-hover-title" style={{ fontSize: '1.25rem' }}>{service.title}</h3>
              </motion.div>
        ...
        <div className="services-container">
          <div className="services-intro-grid">
            <div className="services-intro-block">
              ...
              <h2 className="services-section-title">Transforming Businesses Through Technology, Innovation & Excellence</h2>
            ...
            <div className="services-intro-block" style={{ marginTop: '2.5rem' }}>
              <span className="services-section-subtitle">OUR SERVICES</span>
              <h2 className="services-section-title">End-to-End Solutions for Modern Businesses</h2>
              <div className="services-section-description">
                <p>
                        ...
                        <div className="carousel-card-left-column">
                          ...
                          <div className="carousel-card-body">
                            <div>
                              ...
                              <p className="carousel-card-tagline">{service.tagline}</p>
                            </div>
                            {!isHovered && (
                          ...
                          {isHovered && (
                            ...
                            >
                              <div className="carousel-details-pane-inner">
                                <p className="carousel-details-desc">{service.desc}</p>
                                
                                <div className="carousel-details-section">
                                  <h4 className="carousel-details-section-title">Capabilities</h4>
                                  <ul className="carousel-details-list">
                                    {(service.capabilities || []).slice(0, 3).map((cap, idx) => (
                                      <li key={idx} className="carousel-details-list-item">
                                        <span className="bullet-checkmark">✓</span>
                                        <span className="bullet-text">{cap}</span>
                                      </li>
                                    ))}
                                ...
                                <div className="carousel-details-section">
                                  <h4 className="carousel-details-section-title">Business Benefits</h4>
                                  <ul className="carousel-details-list">
              ...
              <div className="modal-layout-grid">
                ...
                <div className="modal-details-pane">
                  <div className="modal-header">
                    <span className="modal-badge">{selectedService.badge || 'TANVOX CAPABILITY'}</span>
                  ...
                  <div className="modal-actions">
                    <a href="#contact" className="modal-btn-primary" onClick={() => setSelectedService(null)}>
                      Schedule Consultation
                    </a>
                    <a href="#contact" className="modal-btn-secondary" onClick={() => setSelectedService(null)}>
                      Contact Expert
                    </a>
                  </div>
                </div>
